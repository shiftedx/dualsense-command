...
pub(crate) use windows_pnp::is_controller_id as is_windows_pnp_controller_id;
#[cfg(all(test, target_os = "windows"))]
pub(crate) use windows_pnp::{
    candidate_text_is_controller as windows_pnp_candidate_text_is_controller,
    controller_events_from_text as windows_pnp_controller_events_from_text,
    utf16_bytes_to_search_text as windows_utf16_bytes_to_search_text,
};
    ...
    T: DeviceTransport,
{
    ...
    if states.is_empty() {
        events.extend(windows_pnp::controller_events());
    }
