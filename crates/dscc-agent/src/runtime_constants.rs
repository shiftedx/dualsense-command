...
pub(crate) const FORZA_BRAKE_OVERTRAVEL_WARNING_OFFSET: f64 = 0.52;
pub(crate) const FORZA_BRAKE_OVERTRAVEL_WARNING_MIN_POSITION: f64 = 0.48;
pub(crate) const FORZA_BRAKE_OVERTRAVEL_RAMP_CURVE: f64 = 0.8;
pub(crate) const FORZA_BRAKE_FINAL_STOP_ARM_OFFSET: f64 = 0.20;
pub(crate) const FORZA_BRAKE_FINAL_STOP_OFFSET: f64 = 0.20;
