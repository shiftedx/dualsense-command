...
pub(crate) const FORZA_BRAKE_BASELINE_FORCE: f64 = 30.0 / 255.0;
pub(crate) const FORZA_BRAKE_NORMAL_FORCE: f64 = 205.0 / 255.0;
...
pub(crate) const FORZA_BRAKE_CURVE: f64 = 1.45;
...
pub(crate) const FORZA_BRAKE_FINAL_STOP_ARM_OFFSET: f64 = 0.06;
