...
pub(crate) const FORZA_BRAKE_BASELINE_FORCE: f64 = 76.0 / 255.0;
pub(crate) const FORZA_BRAKE_NORMAL_FORCE: f64 = 1.0;
pub(crate) const FORZA_BRAKE_ENDSTOP_FORCE: f64 = 1.0;
...
pub(crate) const FORZA_ABS_RANGE_START_RATIO: f64 = 0.80;
pub(crate) const FORZA_ABS_MIN_SPEED_KMH: f64 = 12.0;
pub(crate) const FORZA_ABS_SLIP_THRESHOLD: f64 = 0.68;
pub(crate) const FORZA_ABS_SLIP_RANGE_WIDTH: f64 = 0.45;
pub(crate) const FORZA_ABS_PULSE_MIN_AMPLITUDE: f64 = 48.0 / 63.0;
pub(crate) const FORZA_ABS_PULSE_MAX_AMPLITUDE: f64 = 1.0;
pub(crate) const FORZA_ABS_PULSE_FREQUENCY_HZ: f64 = 34.0;
pub(crate) const FORZA_ABS_FINE_FLUTTER_WALL_ZONES: f64 = 3.0;
pub(crate) const FORZA_BRAKE_CURVE: f64 = 1.0;
pub(crate) const FORZA_THROTTLE_CURVE: f64 = 2.25;
pub(crate) const FORZA_ENDSTOP_WALL_OFFSET: f64 = 0.03;
pub(crate) const FORZA_BRAKE_OVERTRAVEL_WALL_POSITION: f64 = 0.98;
pub(crate) const FORZA_BRAKE_OVERTRAVEL_MIN_POSITION: f64 = 0.48;
pub(crate) const FORZA_BRAKE_OVERTRAVEL_RAMP_CURVE: f64 = 0.8;
pub(crate) const FORZA_BRAKE_FULL_FORCE_INPUT: f64 = 0.95;
...
pub(crate) const FORZA_REDLINE_FADE_WIDTH: f64 = 0.18;
pub(crate) const FORZA_REDLINE_BLINK_DIM_BLEND: f64 = 0.70;
pub(crate) const FORZA_REDLINE_BLINK_HALF_PERIOD_MS: u64 = 100;
pub(crate) const FORZA_REDLINE_PLAYER_LED_COUNT: u8 = 5;
...
pub(crate) const FORZA_SHIFT_CLUTCH_THRESHOLD: f64 = 0.40;
pub(crate) const FORZA_SHIFT_WITH_CLUTCH_STRENGTH: f64 = 0.58;
...
pub(crate) const FORZA_SHIFT_CLUTCH_CONTINUOUS_BODY_DAMPING: f64 = 1.0;
pub(crate) const FORZA_SHIFT_CLUTCH_CONTINUOUS_BODY_MIN: f64 = 0.08;
