...
- [Game Module PR Template](game-module-template.md): checklist for adding a
  supported game, telemetry parser, or profile pack.
- [Provenance Policy](provenance-policy.md): clean-room source rules for games,
  HID, telemetry, Steam Input, and broker changes.
- [Release Trust](release-trust.md): unsigned MSI policy, checksum validation,
  and installer-flavor boundaries.
- [Module Manifest Format](module-manifest-format.md): draft format for future
  data-only profile packs.
- [Hardware Validation Template](hardware-validation-template.md): sanitized
