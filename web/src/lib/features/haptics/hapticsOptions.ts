...
export const forzaEffectMetas: ForzaEffectMeta[] = [
    ...
    },
    {
      ...
      help: 'Fires a short kick when DSCC detects a gear change. Clutch bite is the percent that counts as pressed; clean shift controls clutch-assisted feedback, missed clutch controls no-clutch feedback, and clutch body damp lowers DSCC continuous road, tire, and drivetrain body layers while the clutch is pressed.'
    },
    {
      id: 'rev_limiter_buzz',
      column: 'throttle',
